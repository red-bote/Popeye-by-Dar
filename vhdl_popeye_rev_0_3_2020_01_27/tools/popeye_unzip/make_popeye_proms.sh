#!/bin/bash
# Popeye ROM conversion to VHDL
# (Port DAR batch file to .sh)
# Red~Bote (Glenn Neidermeier) 10/2024
...
cat 7a 7b 7c 7e > popeye_cpu.bin
./make_vhdl_prom popeye_cpu.bin popeye_cpu.vhd

cat tpp2-c.7a tpp2-c.7b tpp2-c.7c tpp2-c.7e > popeye_cpu_protected.bin
